          ...
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              return directusClient.request(sdkFunction ? sdkFunction(_extends({}, params, {
                fields: fields
              })) : readItems(resource, _extends({}, params, {
                fields: fields
              })));
            case 19:
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 6;
              return directusClient.request(sdkFunction ? sdkFunction(params) : createItem(resource, params));
            case 6:
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.next = 6;
              return directusClient.request(sdkFunction ? sdkFunction(id, params) : updateItem(resource, id, params));
            case 6:
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              ...
              _context5.next = 7;
              return directusClient.request(sdkFunction ? sdkFunction(idsFormatted, params) : updateItems(resource, idsFormatted, params));
            case 7:
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              ...
              _context6.next = 6;
              return directusClient.request(sdkFunction ? sdkFunction(params) : createItems(resource, params));
            case 6:
        ...
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              ...
              _context7.next = 6;
              return directusClient.request(sdkFunction ? sdkFunction(id, params) : readItem(resource, id, params));
            case 6:
        ...
        return _regeneratorRuntime().wrap(function _callee8$(_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            ...
            case 11:
              ...
              _context8.next = 14;
              return directusClient.request(_sdkFunction ? _sdkFunction(id) : deleteItem(resource, id));
            case 14:
        ...
        return _regeneratorRuntime().wrap(function _callee9$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            ...
            case 12:
              ...
              _context9.next = 15;
              return directusClient.request(_sdkFunction2 ? _sdkFunction2(idsFormatted) : deleteItems(resource, idsFormatted));
            case 15:
